    ...
    <>
      <style jsx>{`
        ...
        @media (max-width: 768px) {
          ...
          .metric-card:nth-child(1) .metric-number::before {
            content: '💰';
          }
          .metric-card:nth-child(2) .metric-number::before {
            content: '👥';
          }
          .metric-card:nth-child(3) .metric-number::before {
            content: '📈';
          }
          .metric-card:nth-child(4) .metric-number::before {
            content: '⭐';
          }
        }
