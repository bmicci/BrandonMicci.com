...
export default function PrivacyPage() {
  return (
    <div className="mx-auto max-w-3xl px-6 py-12 prose prose-invert">
      ...
      <h2>Overview</h2>
      <p>
        This site is an executive portfolio for informational purposes. We do
        not sell personal data and we collect the minimum information necessary
        to operate the site.
      </p>
      ...
      <p>
        To understand aggregate site usage and improve content and performance.
      </p>

      <h2>Third-Party Services</h2>
      <p>
        We may use hosting and analytics providers (e.g., Vercel). These
        providers may process IP addresses and basic request metadata to deliver
        the site.
      </p>
